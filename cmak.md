...
But before we must create a _zookeeper node_ [like we did in this exercise](./zookeeper_node_for_kafka.md) for the CMAK app
...
Now we have our application running. To actually use it we have to start a web browser (firefox for example) and connenct to the port _9000_.
